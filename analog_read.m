...
% In Living Room
block.OutputPort(1).Data = double(EngineIO.MemoryMap.Instance.GetFloat(104, EngineIO.MemoryType.Input).Value); %Termostato (Temperature)
block.OutputPort(2).Data = double(EngineIO.MemoryMap.Instance.GetFloat(105, EngineIO.MemoryType.Input).Value); %Termostato (set point)
